...
void func_0016E790(Obj *arg0, Arg1 *arg1) {
    ...
    src = (u128 *)0x70000BE0;
    while (i != arg0->unkE8) {
        *(u128 *)(arg0->unkFC + offVec) = *src;
        *(u128 *)(arg0->unk100 + offVec) = *src;
        *(u128 *)(arg0->unk104 + offVec) = *src;
        p24 = (Sub24 *)((u8 *)arg0->unkEC + offTbl);
        p24->f20 = arg0->unk50 * iter->f0;
        res = func_00100810(0x40, src, 0);
        p24->p24 = res;
        if (res != 0) {
            *(s32 *)res = (s32)&D_0069C300;
            *(s32 *)res = (s32)&D_0069C480;
            *(s32 *)((u8 *)res + 0x30) = iter->f4;
            *(s32 *)((u8 *)res + 0x4) = 0;
            p10 = *(Sub10 **)((u8 *)res + 0x30);
