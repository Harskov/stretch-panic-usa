# func_0016E9A0 @ 0x0016E9A0 — 156 bytes, segment game_01
...
Write attempt-1.c (function named exactly as above; include "ctx.c" declarations you need by copying them, not the file), then:
    ...
    python3 skills/dps2-toolkit/scripts/match.py --repo targets/<slug> try func_0016E9A0 wip/func_0016E9A0/attempt-1.c

On 100:  python3 skills/dps2-toolkit/scripts/ledger.py --repo targets/<slug> mark func_0016E9A0 --from wip/func_0016E9A0/attempt-N.c
Stuck after 3 substantive attempts:  match.py permute func_0016E9A0  then  ledger.py set-status func_0016E9A0 wip
