# func_0017EC80 @ 0x0017EC80 — 208 bytes, segment game_01
...
Write attempt-1.c (function named exactly as above; include "ctx.c" declarations you need by copying them, not the file), then:
    ...
    python3 skills/dps2-toolkit/scripts/match.py --repo targets/<slug> try func_0017EC80 wip/func_0017EC80/attempt-1.c

On 100:  python3 skills/dps2-toolkit/scripts/ledger.py --repo targets/<slug> mark func_0017EC80 --from wip/func_0017EC80/attempt-N.c
Stuck after 3 substantive attempts:  match.py permute func_0017EC80  then  ledger.py set-status func_0017EC80 wip
