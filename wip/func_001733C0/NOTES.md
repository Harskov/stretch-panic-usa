# func_001733C0 @ 0x001733C0 — 128 bytes, segment game_01
...
Write attempt-1.c (function named exactly as above; include "ctx.c" declarations you need by copying them, not the file), then:
    ...
    python3 skills/dps2-toolkit/scripts/match.py --repo targets/<slug> try func_001733C0 wip/func_001733C0/attempt-1.c

On 100:  python3 skills/dps2-toolkit/scripts/ledger.py --repo targets/<slug> mark func_001733C0 --from wip/func_001733C0/attempt-N.c
Stuck after 3 substantive attempts:  match.py permute func_001733C0  then  ledger.py set-status func_001733C0 wip
