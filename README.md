...
**104 of 1355** game functions are matched (0.91 % of the game code by size), and 0 game functions carry a name backed by evidence. 672 SDK and runtime-library functions are identified as library code and are not counted.
